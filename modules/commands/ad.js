...
"https://4.bp.blogspot.com/-yAExPAr7JeA/WDaBRVuJwxI/AAAAAAALb7I/Dbvda0KD5uECF3_SBjsvkl2_mqP9_BweQCLcB/s1600/AS000834_17.gif",
  ...
  var callback = () => api.sendMessage({body:`梁ADMIN BOT梁
  👀 Tên: Yu
  ❎ Tuổi: 20
  👤 Giới tính: Nam
  🙄 Sinh ngày: 26-05-2001
  💫 Chiều cao / cân nặng: 1m7/ 48kg
  💘 Mối quan hệ: ❤️
  😎 Quê quán: Hà Nội
  🤔 Nơi ở: Hà Nội ^^
  ♊️ Cung:Song tử
  👫 Gu: <Chân ngắn, cute :>
  🌸 Tính cách: Dễ tin người ,hay khóc nhè :( .....
  📱Facebook:https://www.facebook.com/vuvuvi.vi.773
...
----Yu----`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
